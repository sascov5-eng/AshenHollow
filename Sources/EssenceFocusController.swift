...
struct EssenceFocusController {
    ...
    init(maxEssence: Int = 100, essencePerHit: Int = 34, healCost: Int = 100, focusDuration: TimeInterval = 1.0) {
    ...
    mutating func beginFocus(currentHP: Int, maxHP: Int) -> Bool {
        guard !isFocusing, !completedHealPending, currentHP > 0, currentHP < maxHP, essence >= healCost else { return false }
        isFocusing = true
