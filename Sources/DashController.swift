...
struct DashController {
    ...
    mutating func tryStart(unlocked: Bool, isGrounded: Bool, inputX: Double, facing: Double) -> Double? {
    ...
    mutating func restoreAirDash() { airDashAvailable = true }
    mutating func cancelActiveDash() { dashRemaining = 0 }
}
