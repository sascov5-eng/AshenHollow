...
enum KingdomMap {
    ...
    static let extraSolids: [CGRect] = {
        ...
        for i in 0..<8 {
            ...
            r.append(CGRect(x: x, y: 156, width: 210, height: 24))
        }
        r.append(CGRect(x: 12800, y: 156, width: 720, height: 24))
        r.append(CGRect(x: 13640, y: 340, width: 54, height: 280))
        r.append(CGRect(x: 14220, y: 156, width: 220, height: 24))
        r.append(CGRect(x: 14520, y: 246, width: 220, height: 24))

        // Город пыли — террасы
        for i in 0..<6 {
            r.append(CGRect(x: 15200 + CGFloat(i) * 680, y: 154, width: 260, height: 26))
        }
        r.append(CGRect(x: 16800, y: 340, width: 70, height: 510))
        r.append(CGRect(x: 17640, y: 156, width: 240, height: 24))
        r.append(CGRect(x: 19340, y: 156, width: 280, height: 24))

        // Костяное гнездо
        r.append(CGRect(x: 20500, y: 156, width: 160, height: 22))
        r.append(CGRect(x: 20740, y: 246, width: 160, height: 22))
        r.append(CGRect(x: 20500, y: 336, width: 160, height: 22))
        r.append(CGRect(x: 20740, y: 426, width: 160, height: 22))
        r.append(CGRect(x: 21840, y: 156, width: 220, height: 24))
        r.append(CGRect(x: 22640, y: 156, width: 260, height: 24))
        r.append(CGRect(x: 23280, y: 156, width: 220, height: 24))
    ...
    static let extraHazards: [HazardSpec] = [
        HazardSpec(id: "acid-1", kind: .spikes, rect: CGRect(x: 10140, y: 90, width: 150, height: 28)),
        HazardSpec(id: "acid-2", kind: .spikes, rect: CGRect(x: 11880, y: 90, width: 150, height: 28)),
        HazardSpec(id: "city-spikes", kind: .spikes, rect: CGRect(x: 18140, y: 90, width: 150, height: 28)),
        HazardSpec(id: "nest-spikes", kind: .spikes, rect: CGRect(x: 20740, y: 90, width: 150, height: 28)),
    ...
    static let extraEnemies: [EnemyTestSpec] = [
        ...
        EnemyTestSpec(id: "nest-fly", kind: .flying, spawn: CGPoint(x: 20800, y: 360), patrolRange: 20640...21040, maxHP: 3, geoReward: 12),
    ...
    static let extraInteractions: [InteractionSpec] = [
        InteractionSpec(id: "moss-lever", kind: .lever, rect: CGRect(x: 13540, y: 90, width: 44, height: 70), linkedID: "moss-door"),
        InteractionSpec(id: "moss-door", kind: .door, rect: CGRect(x: 13640, y: 90, width: 54, height: 250), linkedID: nil),
        InteractionSpec(id: "city-shortcut-lever", kind: .shortcutLever, rect: CGRect(x: 16700, y: 90, width: 44, height: 70), linkedID: "city-shortcut-door"),
